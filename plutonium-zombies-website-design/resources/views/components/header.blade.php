<header>
    ...
    <div class="container">
        <div class="header">
            ...
            <p>Welcome to {{ config('app.name') }}, Where only the bravest of souls venture through <br>the waves of zombies only to meet their demise...</p>
            <div class="playing"><i class="fa-solid fa-circle pulse"></i> 220 players killing zombies</div>
        </div>
    </div>
</header>
