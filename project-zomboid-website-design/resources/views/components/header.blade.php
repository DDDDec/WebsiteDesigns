<header>
    ...
    <div class="background">
        <img src="{{ asset('assets/images/header.jpg') }}" alt="Picture of rust made by salty"/>
    </div>
    ...
    <div class="container">
        <div class="header">
            ...
            <p>Welcome to {{ config('app.name') }}, Where only the bravest of souls venture through <br>the hordes of zombies only to meet their demise...</p>
            <div class="playing"><i class="fa-solid fa-circle pulse"></i> 220 players throwing molotov's</div>
        </div>
    </div>
</header>
